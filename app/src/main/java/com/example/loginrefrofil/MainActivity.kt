...
import com.example.loginrefrofil.databinding.ActivityMainBinding
import com.example.loginrefrofil.retrofit.LoginService
import com.example.loginrefrofil.retrofit.UserInfo
...
/*service.login(UserInfo(email, password)).enqueue(
            object : Callback<LoginResponse>{
                ...
                override fun onFailure( call: Call<LoginResponse>, t: Throwable) {
                    Log.e("Retrofil", "Problemas con el servidor.")
                }
            }
        )
 ...
 */
    ...
    private suspend fun register(email: String, password: String, service: LoginService) {
        lifecycleScope.launch(Dispatchers.IO) {
            try {
